---
title: "나만의 NFT 만들기"
date: 2023-07-16T18:44:31+09:00
draft: true
tags: ["block-chain","NFT","pinata","remix"]
...
![pinata file upload](/images/minting-nft/pinata.png)  
...
![sepolia net deploy](/images/minting-nft/metamaskdeploy.png)  
...
![mintNFT execute](/images/minting-nft/mintingnft.png)  
...
![sepolia net deploy](/images/minting-nft/nftin.png)  

해당그림에서 NFT 가져오기를 완료하면 metamask wallet 에 다음과 같이 나타난다.

![sepolia net deploy](/images/minting-nft/nftreceive.png)  

2. **opensea**: [opensea testnet](https://testnets.opensea.io/) 에서 배포된 contract 주소를 치면 볼 수 있다.

![sepolia net deploy](/images/minting-nft/opensea.png)  
